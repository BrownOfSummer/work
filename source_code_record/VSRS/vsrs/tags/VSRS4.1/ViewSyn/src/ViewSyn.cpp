/*
* Enhansed View Synthesis Reference Software
* ****************************************************************************
...
*
* O. Stankiewicz, K. Wegner, M. Tanimoto, M. Domañski, 
* "Enhanced View Synthesis Reference Software (VSRS) for Free-viewpoint Television"
* ISO/IEC JTC1/SC29/WG11 MPEG2013/M31520 October 2013, Geneva, Switzerland
*
...
int main(int argc , char *argv[]) 
{
  ...
  printf("View Synthesis Reference Software (VSRS), Version %.1f v2\n", VERSION);
  printf("     - MPEG 3DV, July 2013\n\n");
