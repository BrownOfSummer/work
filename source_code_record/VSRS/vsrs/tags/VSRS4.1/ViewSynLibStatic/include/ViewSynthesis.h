...
public:
  ...
  bool    xSynthesizeDepth      (DepthType **pDepthMap);
...
private:
  ...
  bool    depthsynthesis_3Dwarp    (DepthType **pDepthMap);
  bool    depthsynthesis_3Dwarp_ipel  (DepthType **pDepthMap);
...
//  unsigned int  ColorSpace;
  ...
  bool (CViewInterpolationGeneral::*m_pFunc_DepthSynthesis) (DepthType **pDepthMap) ;
